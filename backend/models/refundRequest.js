...
const refundRequestSchema = new mongoose.Schema({
  ...
  accountsBatchStatus: { type: String, enum: ['', 'UNDER_PROCESS', 'ON_HOLD', 'REFUNDED'], default: '' },
  ...
  accountsHoldFlaggedAt: { type: Date },
  accountsHoldFlaggedBy: { type: mongoose.Schema.Types.ObjectId, ref: 'User' },
  accountsHoldFlaggedByName: { type: String, default: '' },
  accountsHoldReason: { type: String, default: '' },
