              ...
              <div className="space-y-5">
                <div className="grid grid-cols-2 gap-3">
                  {[
                    ...
                    ...(claim.festName ? [['Fest', claim.festName]] : []),
                    ...((claim.teamName || claim.committeeName || claim.claimantCommittee) ? [['Committee', claim.teamName || claim.committeeName || claim.claimantCommittee || '—']] : []),
